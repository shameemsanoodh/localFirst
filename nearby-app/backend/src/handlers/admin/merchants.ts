...
// List all merchants
export const listMerchants: APIGatewayProxyHandler = async (event) => {
...
// Suspend merchant
export const suspendMerchant: APIGatewayProxyHandler = async (event) => {
...
// Activate merchant
export const activateMerchant: APIGatewayProxyHandler = async (event) => {
  const merchantId = event.pathParameters?.merchantId;
...
// Delete merchant
export const deleteMerchant: APIGatewayProxyHandler = async (event) => {
  const merchantId = event.pathParameters?.merchantId;
