...
export const notifications = {
     ...
     */
    sendOrderStatusUpdate: async (payload: NotificationPayload) => {
     ...
     */
    notifyUser: async (payload: NotificationPayload) => {
     ...
     */
    notifyMerchant: async (payload: NotificationPayload) => {
     ...
     */
    subscribe: async (topicArn: string, protocol: 'email' | 'sms', endpoint: string) => {
        try {
