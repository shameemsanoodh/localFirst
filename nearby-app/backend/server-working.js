...
// Import all handlers with correct paths
...
import { handler as checkPhone } from './dist/src/handlers/auth/checkPhone.js';

import { handler as authRegister } from './dist/src/auth/register.js';
import { handler as authLogin } from './dist/src/auth/login.js';
import { handler as authGetProfile } from './dist/src/auth/getProfile.js';

import { handler as listCategories } from './dist/src/categories/list.js';
...
app.get('/dev/check-phone/:phone', lambdaToExpress(checkPhone));
...
app.get('/dev/auth/me', lambdaToExpress(authGetProfile));

// Categories
app.get('/dev/categories', lambdaToExpress(listCategories));
