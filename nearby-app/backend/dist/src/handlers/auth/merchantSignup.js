...
export const handler = async (event) => {
    try {
        ...
        const { phone, email, passcode, shopName, ownerName, description, address, majorCategory, subCategory, capabilities, location, timing, openTime, closeTime, whatsapp } = body;
...
//# sourceMappingURL=merchantSignup.js.map