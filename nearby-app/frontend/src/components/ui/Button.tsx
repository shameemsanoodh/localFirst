...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variants = {
    ...
    coral: 'bg-gradient-to-r from-blue-600 to-coral-primary text-white shadow-md hover:shadow-lg',
  ...
  return (
    // @ts-ignore - Framer Motion type conflict with React button props
    <motion.button
