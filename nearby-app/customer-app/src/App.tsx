...
function App() {
  ...
  // Redirect merchants and admins to their respective apps
  if (user?.role === 'merchant') {
    window.location.href = 'https://merchant-d3j65m5o80vf8x.cloudfront.net'
    return null
  }

  if (user?.role === 'admin') {
    window.location.href = 'https://admin-d3j65m5o80vf8x.cloudfront.net'
    return null
  }
